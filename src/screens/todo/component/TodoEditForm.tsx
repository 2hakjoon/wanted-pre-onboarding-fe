...
function TodoEditForm({ closeEditMode }: TodoEditForm) {
  ...
  return (
    <FormWrapper onSubmit={handleSubmit(handleUpdateTodo)}>
      <InputBasic register={register('title')} placeholder="" data-cy="input-edit-todo-title" />
      <InputBasic register={register('content')} placeholder="" data-cy="input-edit-todo-content" />
      <div>
